...
| 3 | **Flash jump** | Jump again, airborne | upright forward dash; from apex lands **≈6 CW** forward. **Repeatable** — the staple ("you're constantly flash-jumping"). Minimal air control: holding the opposite dir right after only trims **~1 CW** | `fj_dist`, `fj_vx`, `fj_vy`, `air_control` | blocked after an up-jump / **sonic-boom ring** |
