...
> **2026-07-15 — HISTORICAL ROADMAP.** The M-series below records the original
> build sequence and is not an active task list. The product pillars still
> bind unless superseded in `DECISIONS.md`. Current work is scoped in
> **docs/ALPHA.md**; the intervening UX reboot is recorded in `REVAMP.md`.
